...
-- Alte Google-Drive-Thumbnail-Links auf den internen Bild-Proxy umstellen,
-- damit Bilder auch ohne öffentliche Google-Hotlinks zuverlässig angezeigt werden.
UPDATE products
SET image_url = regexp_replace(image_url, '^https://drive.google.com/thumbnail\?id=([^&]+).*$', '/drive-image/\1')
