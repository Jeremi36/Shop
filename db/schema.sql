...
SELECT * FROM (VALUES
  ('Wie werde ich für 16+/18+ Kategorien verifiziert?','Öffne eine Support-Konversation. Ein Staff kann deinen Altersstatus nach einer geeigneten Prüfung auf 16+ oder 18+ setzen.',10),
