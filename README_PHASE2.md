...
Siehe `.env.example`. Für Mails werden `RESEND_API_KEY` und eine verifizierte `MAIL_FROM`-Adresse benötigt. Für Bilder werden die drei Cloudinary-Variablen benötigt.
